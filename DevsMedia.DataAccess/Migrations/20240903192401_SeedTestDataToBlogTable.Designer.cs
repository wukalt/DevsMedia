...
namespace DevsMedia.DataAccess.Migrations
{
    ...
    [Migration("20240903192401_SeedTestDataToBlogTable")]
    partial class SeedTestDataToBlogTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevsMedia.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseTime = new DateTime(2024, 9, 3, 22, 53, 59, 523, DateTimeKind.Local).AddTicks(2997),
                        ...
                        new
                        {
                            ...
                            CoverImage = "null for now",
                            ReleaseTime = new DateTime(2024, 9, 3, 22, 53, 59, 523, DateTimeKind.Local).AddTicks(2999),
                            ShortDescription = "SOLID که متشکل از 5 اصل است در برنامه نویسی  بهتر کمک میکمند",
            ...
            modelBuilder.Entity("DevsMedia.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseTime = new DateTime(2024, 9, 3, 22, 53, 59, 523, DateTimeKind.Local).AddTicks(2829),
                        ...
                        new
                        {
                            ...
                            ReleaseTime = new DateTime(2024, 9, 3, 22, 53, 59, 523, DateTimeKind.Local).AddTicks(2841),
                            ShortDescription = ".NET8  آخرین نسخه اصلی از فریم ورک دات نت است، که پس از انتشار نسخه‌های قبلی، این وعده را به کاربران خود داده است که مجموعه‌ای از ویژگی‌های جدید، پیشرفت‌ها و قابلیت‌های جدید را برای توانمند‌سازی بیشتر توسعه‌دهندگان و ایجاد توسعه برنامه‌های کاربردی و لذت بخش به ارمغان بیاورد",
                            Title = "Cyber"
                        });
                });
