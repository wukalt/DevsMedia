...
namespace Delt.DataAccess.Migrations
{
    ...
    [Migration("20240905202405_UpdateBookModel")]
            ...
            modelBuilder.Entity("Delt.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseTime = new DateTime(2024, 9, 5, 23, 54, 2, 554, DateTimeKind.Local).AddTicks(2564),
                        ...
                        new
                        {
                            ...
                            CoverImage = "null for now",
                            ReleaseTime = new DateTime(2024, 9, 5, 23, 54, 2, 554, DateTimeKind.Local).AddTicks(2567),
                            ShortDescription = "SOLID که متشکل از 5 اصل است در برنامه نویسی  بهتر کمک میکمند",
