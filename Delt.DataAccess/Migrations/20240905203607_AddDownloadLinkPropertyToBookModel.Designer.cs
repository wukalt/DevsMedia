...
namespace Delt.DataAccess.Migrations
{
    ...
    [Migration("20240905203607_AddDownloadLinkPropertyToBookModel")]
    partial class AddDownloadLinkPropertyToBookModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Delt.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseTime = new DateTime(2024, 9, 6, 0, 6, 6, 949, DateTimeKind.Local).AddTicks(612),
                        ...
                        new
                        {
                            ...
                            CoverImage = "null for now",
                            ReleaseTime = new DateTime(2024, 9, 6, 0, 6, 6, 949, DateTimeKind.Local).AddTicks(614),
                            ShortDescription = "SOLID که متشکل از 5 اصل است در برنامه نویسی  بهتر کمک میکمند",
