...
namespace Delt.DataAccess.Migrations
{
    ...
    [Migration("20240906113838_AddTeacherTableAndSeedTestDataToTeacherAndSeminar")]
    partial class AddTeacherTableAndSeedTestDataToTeacherAndSeminar
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Delt.Models.Seminar", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Level = 0,
                            ReleaseTime = new DateTime(2024, 9, 6, 15, 8, 37, 477, DateTimeKind.Local).AddTicks(8290),
