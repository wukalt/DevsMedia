...
namespace Delt.DataAccess.Migrations
{
    ...
    [Migration("20240906000738_AddDisplayNameAnotaionForBookModel")]
    partial class AddDisplayNameAnotaionForBookModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Delt.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReleaseTime = new DateTime(2024, 9, 6, 3, 37, 36, 692, DateTimeKind.Local).AddTicks(4699),
                        ...
                        new
                        {
                            ...
                            CoverImage = "null for now",
                            ReleaseTime = new DateTime(2024, 9, 6, 3, 37, 36, 692, DateTimeKind.Local).AddTicks(4701),
                            ShortDescription = "SOLID که متشکل از 5 اصل است در برنامه نویسی  بهتر کمک میکمند",
            ...
            modelBuilder.Entity("Delt.Models.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Publisher = "packt",
                            ReleaseTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(2024),
