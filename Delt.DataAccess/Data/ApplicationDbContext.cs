    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Book>().HasData(
                new Book() { Id = 1, Title = "C# 12 and .NET 8 – Modern Cross-Platform Development Fundamentals Eighth Edition", ShortDescription = ".NET8  آخرین نسخه اصلی از فریم ورک دات نت است، که پس از انتشار نسخه‌های قبلی، این وعده را به کاربران خود داده است که مجموعه‌ای از ویژگی‌های جدید، پیشرفت‌ها و قابلیت‌های جدید را برای توانمند‌سازی بیشتر توسعه‌دهندگان و ایجاد توسعه برنامه‌های کاربردی و لذت بخش به ارمغان بیاورد", CoverImage = "https://content.packt.com/_/image/original/B19586/cover_image_large.jpg", Author = "Mark J Price", Publisher ="packt", ReleaseTime = new DateTime(2024/01/01), DownloadLink="www.google.com" },
                new Book() { Id = 2 , Title = "Cyber", ShortDescription = ".NET8  آخرین نسخه اصلی از فریم ورک دات نت است، که پس از انتشار نسخه‌های قبلی، این وعده را به کاربران خود داده است که مجموعه‌ای از ویژگی‌های جدید، پیشرفت‌ها و قابلیت‌های جدید را برای توانمند‌سازی بیشتر توسعه‌دهندگان و ایجاد توسعه برنامه‌های کاربردی و لذت بخش به ارمغان بیاورد", CoverImage = "https://content.packt.com/_/image/original/B02765/cover_image_large.jpg", Author = "Mark J Price", Publisher = "packt", ReleaseTime = new DateTime(2024 / 01 / 01), DownloadLink = "www.google.com" }
                );
